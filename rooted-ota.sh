...
function patchOTAs() {
  ...
  if ! ls ".tmp/my-avbroot-setup" >/dev/null 2>&1; then
    #  https://github.com/chenxiaolong/m
    git clone https://github.com/schnatterer/my-avbroot-setup .tmp/my-avbroot-setup
    (cd .tmp/my-avbroot-setup && git checkout ${PATCH_PY_VERSION})
  fi
